...
const mapInput = "D:\\Games\\SteamLibrary\\steamapps\\common\\Beat Saber\\Beat Saber_Data\\CustomWIPLevels\\test - enviro - GD\\NormalStandard.dat"
const mapOutput = "D:\\Games\\SteamLibrary\\steamapps\\common\\Beat Saber\\Beat Saber_Data\\CustomWIPLevels\\test - enviro - GD\\EasyStandard.dat"
...
map._notes.forEach(x => {
    if (x._customData && x._customData._track == trackName) {
        ...
        pillarScale[0] *= pillarToNoodleUnits * 179;
        pillarScale[1] *= pillarToNoodleUnits / 140;
        pillarScale[2] *= pillarToNoodleUnits * 179;
